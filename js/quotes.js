/**
 * Stolen code from https://codepen.io/ahmady09/pen/PNejyN
 * Just removed the rand from autors and hardcoded Lovecrat
 */
    ...
    setHtml = function(q) {
       $('#quote').html(
           '<p class="mb-0">'+ q.quote +'</p>' +
            '<footer class="blockquote-footer">'+ q.titles +'</footer>'
       );
    },
    getQuote =  function() {
        $quote.css('opacity','0');
